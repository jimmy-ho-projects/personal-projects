// SWEEP_ANGLE_MATLAB_2

// Code Author: Jimmy Ho
// Start date: May 2023 (ongoing)
// Date Uploaded: May 2023
// Current Status: Work-in-Progress
// Comments: 
//  removed sweep for simplicity (1-nitro too dark for threshold)
//=============================
//  Hardware:
//  Arduino UNO
...
float pv_Voltage = 0;
float pv_Threshold = 1.0; //compares analoge reading
int numReadings = 5;
...
//  
  myStepper.step(100); delay(1000); //100 steps distance between cuvettes
